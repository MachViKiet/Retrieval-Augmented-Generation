...
const useData = () => {
    // ENABLE_OPTIONS = ['Success', 'Rejected'];
  ...
  const rows = [
    createData(Math.floor(10000000 + Math.random() * 90000000),'Giới thiệu Khoa.pdf', 33, '01/08/2024 15:50:33', 'Cơ Bản', false, 'Processing', ['rename', 'download', 'delete']),
    createData(Math.floor(10000000 + Math.random() * 90000000),'Quy Định Và Chính Sách.pdf', 534, '02/08/2024 15:50:33', 'Cơ Bản', true,'Completed', ['rename', 'download', 'delete']),
    createData(Math.floor(10000000 + Math.random() * 90000000),'Lịch Học Và Lịch Thi.pdf', 213, '02/08/2024 15:50:33', 'Cơ Bản', false,'Processing', ['rename', 'download', 'delete']),
    createData(Math.floor(10000000 + Math.random() * 90000000),'Hệ Thống Hỗ Trợ Sinh Viên.pdf', 22, '02/07/2024 15:50:33', 'Cơ Bản', true,'Completed', ['rename', 'download', 'delete']),
    createData(Math.floor(10000000 + Math.random() * 90000000),'Hoạt Động Ngoại Khóa.pdf', 455, '02/01/2024 15:50:33', 'Cơ Bản', true,'Processing', ['rename', 'download', 'delete']),
    createData(Math.floor(10000000 + Math.random() * 90000000),'Thông Tin Liên Hệ.pdf', 11, '02/08/2023 15:50:33', 'Cơ Bản', true,'Rejected', ['rename', 'download', 'delete']),
  ];
